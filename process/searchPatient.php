...
if (!isset($_POST['search']) || empty($_POST['search'])) {
    echo json_encode(["error" => "Search term missing"]);
    exit;
}

$search = '%' . $_POST['search'] . '%'; // Wildcards for LIKE search
...
$query = "
    ...
    AND (u.first_name LIKE ? OR u.last_name LIKE ? OR CONCAT(u.first_name, ' ', u.last_name) LIKE ? OR u.user_id LIKE ?)";
